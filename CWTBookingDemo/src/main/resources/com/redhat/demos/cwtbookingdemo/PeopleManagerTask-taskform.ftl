...
<div id="container">
	<div id="header">
		User Task Form: AirlineReservationDemo.PeopleManagerTask
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Info</legend>
            	...
            	<div class="div_checkbox"><![CDATA[Airline Reservation Notification]]></div>
            <div class="clear"></div>
          </fieldset>

		<fieldset>
            <legend>Task Inputs</legend>
                            		<label for="name">tseg15</label>
                            		<div class="div_checkbox">
                              		${tseg15}
                            		</div>
                            		<label for="name">tprof15</label>
                            		<div class="div_checkbox">
                              		${tprof15}
                            		</div>
